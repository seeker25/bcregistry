      ...
      <v-container fluid no-gutters class="pl-0 ma-0 pr-10">
        ...
        <v-row>
          ...
          <v-col cols="8" class="menu-info-bold"
            >The new BC Registries account supports the following
            services:</v-col
          >
          <v-col cols="2"></v-col>
        </v-row>
        ...
        >
          <v-card elevation="2" max-width="375px" class="mr-5 mb-8">
            ...
            <v-card-text class="menu-item pl-7 pr-7">
              ...
              <p class="pt-7 ma-0 pb-6">
                ...
                <v-icon class="pl-1" color="#1A5A96" dark dense
          ...
          <v-card elevation="2" max-width="375px" class="mr-5 mb-8">
            <v-card-title class="menu-header pr-0 mr-0">
              <v-row>
                <v-col cols="9">
                ...
                <v-col cols="3">
                  <v-row>
                    <v-col cols="auto" class="menu-title-badge ml-3 mr-2 pt-0"
                      >NEW</v-col
                    >
                  </v-row>
                  <v-row>
          ...
          <v-card elevation="2" max-width="375px" class="mr-5 mb-8">
            <v-card-title class="menu-header pr-0 mr-0">
              <v-row>
                ...
                <v-col cols="5">
                  <v-row>
                    <v-col cols="auto" class="menu-title-badge ml-0 mr-4 pt-0"
                      >COMING SOON</v-col
                    >
                  </v-row>
                  <v-row>
              ...
              <v-row>
                ...
                <v-col cols="3">
                  <v-row>
                    <v-col
                      cols="auto"
                      class="menu-title-badge ml-0 pl-2 mr-3 pt-0"
                      >ALPHA</v-col
                    >
                  </v-row>
                  <v-row>
        ...
        <div class="payment pt-7 pb-7 mr-10">
          ...
          <v-row no-gutters class="ma-0 pa-0">
            ...
            <v-col cols="6" class="payment-info" style="max-width: 850px"
              ...
              depending depending depending on the account and transaction type,
              including card, online banking, BC OnLine, and pre-authorized
              debit (PAD).
            </v-col>
            <v-col cols="3"></v-col>
          </v-row>
